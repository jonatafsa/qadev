...
//Import do firebase
import { getAuth, onAuthStateChanged, signInWithEmailAndPassword, GoogleAuthProvider, signOut, signInWithPopup } from "firebase/auth";
...
export function AuthContextProvider(props: AuthContextProviderProps) {
  ...
  async function googlePopUpSignIn() {
    ...
    signInWithPopup(auth, provider)
      .then((result) => {
        ...
        toast.error("Erro ao fazer login com o Google" + errorMessage)
        // ...
      });
  }
  ...
  function logout() {
    ...
    const admin = document.querySelector("body");
  ...
  return (
    <AuthContext.Provider value={{ user, signIn, googlePopUpSignIn, logout }}>
      {props.children}
